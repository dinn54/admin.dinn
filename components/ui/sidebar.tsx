...
function SidebarMenuButton({
  ...
  // Create the base component (button or render prop)
  ...
  if (render && React.isValidElement(render)) {
    Comp = React.cloneElement(render as React.ReactElement<any>, {
      "data-slot": "sidebar-menu-button",
      "data-sidebar": "menu-button",
      "data-size": size,
      "data-active": isActive,
      className: cn(sidebarMenuButtonVariants({ variant, size }), className, (render.props as any).className),
      ...props,
    } as any)
  }
